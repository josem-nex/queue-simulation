...
\begin{itemize}
    ...
    Tomando $\alpha = 0.05 y viendo que la formula P_c es decreciente a medida que los valores de c aumentan, como para 
    c = 5 el p-value es 0.0367, entonces podemos deducir que la hipótesis nula es cierta. Por tanto la cantidad óptima de 
    líneas en el horario pico c, debe ser mayor o igual que 5.
\end{itemize}
